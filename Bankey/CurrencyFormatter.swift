...
class CurrencyFormatter {
    func makeAttributedString(_ amount: Decimal) -> NSMutableAttributedString {
    ...
    func dollarsFormatted(_ dollars: Double) -> String {
        ...
        if let resut  = formatter.string(from: dollars as NSNumber) {
            return resut
        }
    ...
    private func makeBalanceAttributed(dollars: String, cents: String) -> NSMutableAttributedString {
        ...
        let centsAttributes = NSAttributedString(string: cents, attributes: centAttributes)
        
        rootString.append(dollarString)
        rootString.append(centsAttributes)
